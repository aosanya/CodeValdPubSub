...
|--------|-------|----------|--------|------------|
| [BUG-20260610-001](bug-details/BUG-20260610-001_events_after_fence_drops_all_events.md) | `GET /pubsub/{agency}/events?after=…` drops every event because stored events have no `timestamp` field | High | 🚀 In Progress | — |
